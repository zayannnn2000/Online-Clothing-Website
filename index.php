...
<head>
  ...
  document.getElementById("pro-container1").innerHTML = this.responseText;
    }
...
function addtoCart (p) {
   ...
   xhttp.send("value="+p);
    ...
    <section id="products" class="section-p1">
        ...
        <div class="pro-container" id="pro-container1">
            <div class="pro">
            ...
            <div class="pro">
                <img id="p_image" src="img/pro2.jpg" alt="">
                <div class="des">
                    <span id="p_brand">Zara</span>
                    <h5 id="p_name">Violet Hues Cropped Long-Sleeved Top</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
    ...
    <section id="banner3" class="section-p1">
        ...
        <div class="banner-box banner-box2">
            ...
            <a href = "shop.php">
            <button class="normal2">View Now</button></a>
        </div>
    </section>
